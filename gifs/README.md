...
- `plotly_anim` was generated by the following steps: running `plotly_viz.py`, using a video editor to capture the animation as an MP4, and converting the MP4 manually to a GIF
