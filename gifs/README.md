...
- `plotly_anim` was generated by the following steps: running `plotly_viz.py`, using a video editor to capture the animation as a video, and converting the MP4 manually to a GIF - this animation was created to provide a Python alternative to `ggplot2_anim.gif`; however, we did not provide a fully baked program to reproduce the figure
